...
//
//   let musixMatchModel = try? newJSONDecoder().decode(MusixMatchModel.self, from: jsonData)
//
// To read values from URLs:
//
//   let task = URLSession.shared.musixMatchModelTask(with: url) { musixMatchModel, response, error in
//     if let musixMatchModel = musixMatchModel {
//       ...
//     }
//   }
//   task.resume()
...
extension URLSession {
    ...
    func musixMatchModelTask(with url: URL, completionHandler: @escaping (MusixMatchModel?, URLResponse?, Error?) -> Void) -> URLSessionDataTask {
